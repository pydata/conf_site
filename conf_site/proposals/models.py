...
class Proposal(ProposalBase):
    ...
    stipend = models.BooleanField(
        ...
        help_text=(
            ...
            "based on need; the quantity available will depend on "
            "successful sponsorship of this effort. "
            "<strong>If a stipend would make a difference in your ability "
            "to prepare and present your material<strong>, "
            "please check this box for consideration for this funding. "
            "Proposal selection is need-blind; asking to be considered "
            "for need-based stipends will have no bearing on "
            "the consideration or likelihood of acceptance of your proposal."
        ),
